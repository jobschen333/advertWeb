        ...
        success: function (data) {
            ...
            var tableIns = table.render({
                ...
                cols : [[
                    ...
                    {field: 'sendAddress', title: '转出地址', width:"20%"},
                    {field: 'sendToken', title: '转账金额', align:'center', width:"20%"},
                    {field: 'remark', title: '备注', align:'center', width:"20%"},
                    {field: 'status', title: '备注', align:'center', width:"10%"},
                    {field: 'addTime',width:"20%", title: '添加时间', align:'center',templet: '<div>{{ layui.laytpl.toDateString(d.add_time) }}</div>'}
